            	...
            	<%        
					for(int i = 0; i < messages.size(); i++) {
                	 ...
                	 <tr>
                     	...
                     	<%if (!msg.unread()) {%>
                    	 	<td align="left" width="22%"><b><a href="profile.jsp?user=<%=sender.user_id%>"><%=sender.getUsername() %></b></a></td>
                 ...
                 <% }%>
                           ...
                           <hr>
                                        ...
                                        <select id="action-select" name="update_type">
                                                ...
                                                <input type="submit" class="small-button" id="inbox-action-button" name="inbox_update" value="Update"></span>
                                        </div>
                <%                
                        }
                %>
