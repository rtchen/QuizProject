...
<ex:push key="body.content">
	...
	<%
       ArrayList<Message> messages = currentUser.getSentMessages();
       if (messages.isEmpty()) {
               %><center><h> No Sent mail! </h></center><% 
       } else {
     %>
					...
					for(int i = 0; i < messages.size(); i++) {
                	 ...
                	 <tr>
                    	 ...
                    	 <input type="checkbox" id="checkbox<%=i%>" name="check" value="<%=msg.getMessageID()%>"></td>
                      		<td align="left" width="22%"><a href="profile.jsp?user=<%=receiver.user_id%>"><%=receiver.getUsername()%></a></td>
                     	 	<td align="left" width="49%"><a href="readSentMessages.jsp?msg_id=<%=msg.getMessageID()%>"><%=msg.getSubject()%></a></td>
                 ...
                 <% }%>
                           ...
                           <hr>
                                        ...
                                        <select id="action-select" name="update_type">
                                                ...
                                                <input class="small-button" id="inbox-action-button" type="submit" name="sent_update" value="Update"></span>
                                        </div>
                <%                
                        }
                %>
